...
import { DEFAULT_NODE_CONFIG } from '../config/default-config';

/** 性能优化常量 */
export const PERFORMANCE_CONSTANTS = {
  /** 空间索引启用阈值（节点数量超过此值使用空间索引） */
  SPATIAL_INDEX_THRESHOLD: 50,
  /** 默认节点宽度（与 DEFAULT_NODE_CONFIG 保持一致） */
  DEFAULT_NODE_WIDTH: DEFAULT_NODE_CONFIG.defaultWidth,
  /** 默认节点高度（与 DEFAULT_NODE_CONFIG 保持一致） */
  DEFAULT_NODE_HEIGHT: DEFAULT_NODE_CONFIG.defaultHeight,
  /** 缓存最大大小 */
  CACHE_MAX_SIZE: 500,
  /** 缓存清理大小 */
