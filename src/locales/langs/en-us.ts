const local: App.I18n.Schema = {
  ...
  page: {
    ...
    announcementManagement: {
      ...
      status: 'Status',
      sticky: 'Sticky',
      stickyPlaceholder: 'Pinned announcements appear at the top of the list',
      viewCount: 'Views',
      publish: 'Publish',
      republish: 'Republish',
      ...
      createDraftHint: 'New announcements are saved as drafts and can be published from the list.',
    ...
    notificationManagement: {
      ...
      createDraftHint: 'New notifications are saved as drafts and can be published from the list.',
      confirmPublishTitle: 'Confirm Publish',
    ...
    alertManagement: {
      ...
      namePlaceholder: 'Enter alert title',
      messagePlaceholder: 'Enter alert message',
      sourcePlaceholder: 'Enter source (optional)',
      ...
      confirmBatchDelete: 'Delete {count} selected alerts?',
      selectAlertsToDelete: 'Please select alerts to delete',
      getDetailFailed: 'Failed to load alert details'
    },
    logManagement: {
      title: 'Request Logs',
      action: 'Action',
      ...
      batchDeletePartialSuccess: 'Deleted {deleted}, failed to delete {failed}',
      confirmClearOldLogs: 'Delete logs older than {days} days?',
      clearOldLogs: 'Clear Old Logs',
      clearOldLogsSuccess: 'Deleted {count} old logs',
      logType: 'Log Type',
      logTypePlaceholder: 'Select log type',
      logTypeAccess: 'Access Logs',
      ...
      logDetailNotFound: 'Log not found or has been deleted',
    ...
    versionLogManagement: {
      ...
      hasDeprecations: 'Deprecated',
      createdAt: 'Created At',
      searchPlaceholder: 'Search title or description',
      versionPlaceholder: 'Enter version (e.g. 1.0.0 or 1.0.0-beta)',
      titlePlaceholder: 'Please enter release title',
      releaseDatePlaceholder: 'Please select release date',
      descriptionPlaceholder: 'Please enter description (optional)',
      featuresPlaceholder: 'Enter new features, one per line',
      fixesPlaceholder: 'Enter bug fixes, one per line',
      improvementsPlaceholder: 'Enter improvements, one per line',
      breakingPlaceholder: 'Enter breaking changes, one per line',
      securityPlaceholder: 'Enter security updates, one per line',
      deprecatedPlaceholder: 'Enter deprecations, one per line',
      versionRequired: 'Please enter version number',
      titleRequired: 'Please enter release title',
      versionInvalid: 'Invalid version format. Use x.y.z or x.y.z-suffix (e.g. 1.0.0-beta)',
      versionPrereleaseAutoHint:
        'Versions with a - suffix are automatically marked as pre-release by the server',
      versionStableAutoHint: 'Versions without a - suffix are marked as stable releases',
