const local: App.I18n.Schema = {
  ...
  page: {
    ...
    resourceManagement: {
      ...
      statusPlaceholder: 'Status',
      codePlaceholder: 'Lowercase letters, digits, underscores, hyphens',
      namePlaceholder: 'Enter resource name',
      descriptionPlaceholder: 'Enter description (optional)',
      codeRequired: 'Please enter resource code',
      nameRequired: 'Please enter resource name',
      codeInvalid: 'Invalid resource code format',
      getDetailFailed: 'Failed to get resource details'
    },
    ...
    menuManagement: {
      ...
      activeMenuHint:
        'Only for hidden sub-pages: pick the parent menu item to highlight in the sidebar',
      activeMenuPlaceholder: 'Select a menu item from the tree',
      permissionCodes: 'Visible Permissions',
      permissionCodesHint: 'Select permission codes required to access this page',
      permissionCodesRequired: 'Select at least one permission code',
      ...
      emptyTree: 'No menus yet. Import route registry from code.',
      ...
      syncRoutesHint: 'Import route registry from frontend code (when adding new pages)',
      syncConfirm:
      ...
      syncSuccess:
        'Sync done: menus created {menusCreated}, updated {menusUpdated}; registry created {registryCreated}, updated {registryUpdated}; skipped {skipped}',
    ...
    announcementManagement: {
      ...
      priorityPlaceholder: 'Priority (0+, higher ranks first)',
      expiresAtPlaceholder: 'Please select expiration time',
      targetAudiencePlaceholder: 'Comma-separated audiences; leave empty for all',
      ...
      createDraftHint:
        'New announcements are saved as drafts. Publish them from the list when ready.',
      confirmPublishTitle: 'Confirm Publish',
      confirmPublish: 'Publish "{title}" now?',
      confirmRepublishTitle: 'Confirm Republish',
      confirmRepublish: 'Republish "{title}" now?',
      confirmRevertToDraftTitle: 'Confirm Revert to Draft',
      confirmRevertToDraft:
        'This clears the publish time and moves the announcement back to draft. Revert "{title}"?',
      confirmArchiveTitle: 'Confirm Archive',
      confirmArchive: 'Archived announcements are hidden from users. Archive "{title}"?',
      publishSuccess: 'Published successfully',
      republishSuccess: 'Republished successfully',
      revertToDraftSuccess: 'Reverted to draft',
      archiveSuccess: 'Archived successfully',
      batchDeleteSuccess: 'Batch delete successfully',
      draftOnlyDelete: 'Only draft items can be deleted',
    ...
    notificationManagement: {
      ...
      priorityLow: 'Low (0)',
      priorityNormal: 'Normal (1)',
      priorityHigh: 'High (2)',
      priorityUrgent: 'Urgent (3)',
      ...
      priorityPlaceholder: 'Select priority (0-3)',
      expiresAtPlaceholder: 'Please select expiration time',
      ...
      createDraftHint:
        'New notifications are saved as drafts. Publish them from the list when ready.',
      confirmPublishTitle: 'Confirm Publish',
      confirmPublish: 'Publish "{title}"?',
      confirmRepublishTitle: 'Confirm Republish',
      confirmRepublish: 'Republish "{title}"?',
      confirmRevertToDraftTitle: 'Confirm Revert to Draft',
      confirmRevertToDraft:
        'The notification will return to draft and clear publish time. Revert "{title}"?',
      confirmArchiveTitle: 'Confirm Archive',
      confirmArchive: 'Archived notifications stop delivery. Archive "{title}"?',
      publishSuccess: 'Published successfully',
      republishSuccess: 'Republished successfully',
      revertToDraftSuccess: 'Reverted to draft',
      archiveSuccess: 'Archived successfully',
