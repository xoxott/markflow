...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  'login': () => import('@/views/_builtin/login/index'),
  'chat': () => import('@/views/chat/index'),
  'component': () => import('@/views/component/index'),
  'knowledge-base': () => import('@/views/knowledge-base/index'),
  'knowledge-base-documents': () => import('@/views/knowledge-base/documents/index'),
