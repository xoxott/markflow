    ...
    type Schema = {
      ...
      page: {
        ...
        announcementManagement: {
          ...
          confirmRevertToDraftTitle: string;
          confirmRevertToDraft: string;
          confirmArchiveTitle: string;
          confirmArchive: string;
          publishSuccess: string;
          republishSuccess: string;
          revertToDraftSuccess: string;
        ...
        logManagement: {
          ...
          confirmBatchDelete: string;
          batchDeletePartialSuccess: string;
          confirmClearOldLogs: string;
          clearOldLogs: string;
          clearOldLogsSuccess: string;
          logType: string;
        ...
        versionLogManagement: {
          ...
          deprecatedPlaceholder: string;
          versionRequired: string;
          titleRequired: string;
          versionInvalid: string;
          versionPrereleaseAutoHint: string;
          versionStableAutoHint: string;
